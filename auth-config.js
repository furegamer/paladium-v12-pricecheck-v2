window.PRICECHECK_AUTH = {
  ...
  loginRedirect: "https://furegamer.github.io/paladium-v12-pricecheck-v2/auth-callback.html"
};
const PC_V="24.0";
...
if(location.pathname.endsWith('/admin.html'))for(const file of ['admin-presence.js','price-reports.js','creator-admin.js','admin-price-context.js','admin-guard.js']){const s=document.createElement('script');s.src=file+'?v='+PC_V;s.defer=true;document.head.appendChild(s)}

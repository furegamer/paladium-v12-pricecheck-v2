...
if(location.pathname.endsWith('/admin.html')){
  ...
  s.src='admin-guard.js?v='+PC_V;
  document.head.appendChild(s);
  for(const file of ['admin-presence.js','price-reports.js','creator-admin.js','admin-price-context.js']){
    const x=document.createElement('script');x.src=file+'?v='+PC_V;x.defer=true;document.head.appendChild(x)
  }
}

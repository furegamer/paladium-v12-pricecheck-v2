...
if(location.pathname.endsWith('/admin.html'))for(const file of ['admin-presence.js','price-reports.js','creator-admin.js','admin-price-context.js']){const s=document.createElement('script');s.src=file+'?v=17.0';s.defer=true;document.head.appendChild(s)}
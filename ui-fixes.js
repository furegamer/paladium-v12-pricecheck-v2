(() => {
  ...
  style.textContent = `
    .pc-profile-slot{width:min(1100px,calc(100% - 28px));margin:10px auto 0;padding:12px 18px;display:flex;align-items:center;justify-content:space-between;gap:14px;border:1px solid rgba(110,100,55,.28);border-radius:18px;background:linear-gradient(100deg,#f2eee0,#e9e2d2);color:#171717;box-shadow:0 6px 18px rgba(0,0,0,.08);cursor:pointer;transition:.18s ease;position:relative;z-index:2}
